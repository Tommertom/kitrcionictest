<svelte:head>
  <title>Ionic Companion - Tabs Music</title>
</svelte:head>
...
<ion-content fullscreen class="ion-padding">
  <h1>Music</h1>
  Music <br /> Contrary to popular belief, Lorem Ipsum is not simply random text.
  ...
  comes from a line in section 1.10.32. <br /> Contrary to popular belief, Lorem
